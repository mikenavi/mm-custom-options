### v2.0.0 UPDATED 22/06/2023

- [Примеси конфигов `Mixins`](#mixins) - добавочные конфиги, которые можно включать в товары и управлять централизованно
- [Расширения конфигов `Extensions`](#extensions) - "прайс-листы на стероидах",расширение конфигов, для гибкого управления ценами в поворяющихся опциях
