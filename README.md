### v1.4.0 - 1.5.0 UPDATED 16/02/2022 :octopus:
...
- :octopus: Значение может иметь альтернативный (расширенный) синтаксис в виде объекта, который используется, в том числе, для указания недоступности опции при выбранном паренте (новый режим)
...
`parentsMode` - тип: строка :octopus:
