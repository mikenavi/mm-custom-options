...
~~:exclamation: Внимание, не может быть носителем собсвенной "цены", а также пока что не может быть парентом для других опций, цену опции эвента можено задавать через парента (можно скрытого). Данная механика находится в процессе реализации~~
