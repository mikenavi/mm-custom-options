...
![#c5f015]UPDATE если название опции начинается с символа `_` то данная значение не будет отражено в корзине клиента, но будет передана в ордер администраторам
