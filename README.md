...
- :star: если `title` опции начинается с символа `_`, то данная не будет отображена в корзине клиента, но будет передана в ордер администраторам
